...
namespace DiscogsClient.Client
{
    internal class DiscogsWebClient : RestSharpWebClient, IDiscogsWebClient
    {
        ...
        private const string _CollectionAll = "/users/{userName}/collection/folders/0/releases";
        ...
        public IRestRequest GetCollection(string userName)
        {
            return GetRequest(_CollectionAll).AddUrlSegment(nameof(userName), userName);
        }
