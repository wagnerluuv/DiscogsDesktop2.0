...
namespace DiscogsClient
{
    public interface IDiscogsDataBaseClient : IDiscogsReleaseRatingClient
    {
        ...
        /// <summary>
        /// Get all releases of a users collection.
        /// See https://www.discogs.com/developers/#page:user-collection,header:user-collection-collection.
        /// </summary>
        /// <param name="userName">T´he name of the user</param>
        /// <param name="max">Number maximum of elements. If null return all elements.</param>
        /// <returns></returns>
        IObservable<DiscogsCollectionRelease> GetCollectionReleases(string userName, int? max = null);
